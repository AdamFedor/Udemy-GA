...
//   d3.select("#quotes")
//     .selectAll('li') // make sure it selects from the parent, otherwise this will be the HTML
//     .data(quotes)
//     .enter() // only effects the new items since using enter()
//     .append('li')
...
add.on('click', function () {
  ...
  listItems
    ...
    .style('background-color', d => colors[d.rating])
    .style('border-radius', '8px')
  .merge(listItems) // why it is stored in a variable
    .style('color', '#5599ff');
  add.remove();
})
